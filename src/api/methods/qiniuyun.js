...
alovaInstance.Post("/qiniu_data/progress", { timeout: 1000 * 60 ,params:params});
...
export const fetchDeleteQiniuData = id => alovaInstance.Delete('/qiniu_data/delete/' + id);

export const fetchDeleteQiniuDataByQiniuKey = qiniu_key => alovaInstance.Delete('/qiniu_data/delete_by_qiniukey/' + qiniu_key);
